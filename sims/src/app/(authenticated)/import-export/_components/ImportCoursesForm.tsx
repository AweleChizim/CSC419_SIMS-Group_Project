...
import { downloadCourseTemplate } from './csvTemplateUtils';
...
interface ImportCoursesFormProps {
    onSuccess?: () => void;
}

export default function ImportCoursesForm({ onSuccess }: ImportCoursesFormProps) {
    ...
    const [parsedData, setParsedData] = useState<ParsedCourseData[]>([]);
    ...
    const handleConfirmImport = async () => {
        ...
        try {
            const result = await importCoursesMutation({
                csvContent,
            ...
            if (result.success) {
                setAlertMessage({
                    ...
                    message: result.message || `Successfully imported ${result.imported} course(s)`,
                });
    ...
    return (
        <div className="space-y-6">
            ...
            <ComponentCard
                ...
                desc="Upload a CSV file to import courses into the system"
            >
                <div className="space-y-6">
                        ...
                        <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-gray-700 dark:text-gray-300">
                                    {isValidating ? 'Validating CSV data...' : 'Importing courses...'}
                                </span>
                            </div>
                        </div>
                    )}
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                                        {parsedData.slice(0, 10).map((course, idx) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">
                                                        <div className="max-w-xs truncate" title={course.prerequisites}>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
                            You are about to import <strong>{validRows}</strong> course(s) into the system.
                        </p>
